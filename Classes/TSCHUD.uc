...
defaultproperties
{
    ...
    hintEnemyBase="Get out from the Enemy Base before the Gnome kills you!"
    ...
    hintSetupEnemyBase="Cannot use Gnome on the Enemy Base!"
    hintBaseLostTrader="You left your Gnome alone for too long, and he went away. Now you'll have to survive the wave without a Base"
