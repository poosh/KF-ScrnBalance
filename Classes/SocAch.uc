...
defaultproperties
{
    ...
    AchDefs(8)=(id="CovidiotParty",DisplayName="Covidiot Party",Description="The entire 4+player team got infected",Icon=Texture'ScrnAch_T.SocIso.CovidiotParty',MaxProgress=1,DataSize=1,bForceShow=True)
}
