...
defaultproperties
{
    ...
    AchDefs(4)=(id="WinCustomMapsHard",DisplayName="Pound Cake",Description="Survive on %c custom maps against Super/Custom specimens and Hardcore Level 5+",Icon=Texture'KillingFloor2HUD.Achievements.Achievement_110',MaxProgress=5,DataSize=3,Group="MAP",FilterMaskAll=2)
    AchDefs(5)=(id="WinCustomMapsSui",DisplayName="Cyanide Cake",Description="Survive on %c custom maps in Turbo/Nightmare/SocIso/Custom game and HL 10+",Icon=Texture'KillingFloor2HUD.Achievements.Achievement_111',MaxProgress=5,DataSize=3,Group="MAP",FilterMaskAll=4)
    AchDefs(6)=(id="WinCustomMapsHoE",DisplayName="Devil Cake",Description="Survive on %c custom maps in FTG/XCM/Doom3 game and HL 15+",Icon=Texture'KillingFloor2HUD.Achievements.Achievement_112',MaxProgress=3,DataSize=3,Group="MAP",FilterMaskAll=8)
