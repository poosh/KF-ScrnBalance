...
defaultproperties
{
    ...
    KFHints[0]="ScrN Balance: You can reload a single shell into Boomstick."
    KFHints[1]="ScrN Balance: Medics have regular frag nades. Do not blow yourself up!"
    KFHints[2]="ScrN Balance: Combat Shotgun is made much better. Give it a try."
    KFHints[3]="ScrN Balance: Shotguns, except Combat and Boomstick, penetrate fat bodies worse than small enemies."
    KFHints[4]="ScrN Balance: M99 cannot stun Scrake with a body-shot. Crossbow has no fire speed bonus as in the original game before v1035."
    KFHints[5]="ScrN Balance: M14EBR has different laser sights. Choose the color you like!"
    KFHints[6]="ScrN Balance: Hand grenades can be 'cooked'. Enable/disable that on 'Scrn Features' page in the Main Menu."
    ...
    KFHints[9]="ScrN Balance: Gunslinger becomes a Cowboy while using dual pistols without wearing an armor but jacket. Cowboy moves, shoots, and reloads his pistols much faster. From the other side, he dies faster too.."
    KFHints[10]="ScrN Balance: Berserker, while holding non-melee weapons, moves slower than other perks."
    KFHints[11]="ScrN Balance: Chainsaw's secondary fire can stun Scrakes the same way as an Axe."
    KFHints[12]="ScrN Balance: Chainsaw consumes fuel. Raised power makes it a beast... until you need to refill"
    KFHints[13]="ScrN Balance: Support Spec. may use Chainsaw. Remember Evil Dead? Try the Chainsaw+Boomstick loadout."
    KFHints[14]="ScrN Balance: Medic, while holding a syringe, runs same fast as while holding a knife."
    KFHints[15]="ScrN Balance: Medics can heal much faster than other perks. If you aren't a Medic, don't screw up the healing process with your lame injection."
    KFHints[16]="ScrN Balance: FN-FAL has bullet penetration and 2-bullet fixed burst mode."
    KFHints[17]="ScrN Balance: MK23 has no bullet penetration but double size of magazine, comparing to Magnum .44"
    KFHints[18]="ScrN Balance: Your experience and perk bonus levels may be different. If they are, you see two perk icons on the HUD."
    KFHints[19]="ScrN Balance: If you see two perk icons on the HUD, the left one shows your experience level, the right - actual level of perk bonuses that you gain."
    KFHints[20]="ScrN Balance: Flares deal the incremental burn Damage over Time (iDoT). The more you shoot the more damage zeds take from burning."
    KFHints[21]="ScrN Balance: Medic nades are for healing only. Zeds are not taking damage neither fear them."
    KFHints[22]="ScrN Balance: If you have just joined the game and got blamed - maybe it is just a welcome gift. Don't worry - shit happens."
    KFHints[23]="ScrN Balance: Nailgun can nail enemies to walls... nail them alive! Crucify your ZED!"
    KFHints[24]="ScrN Console Command: TOGGLEPLAYERINFO - hides health bars while keeping the rest of the HUD."
    KFHints[25]="ScrN Console Command: MVOTE - access to ScrN Voting. Type MVOTE HELP for more info."
    KFHints[26]="ScrN Console Command: DROPALLWEAPONS - drops all your weapons to the ground. What else did you expected?"
    KFHints[27]="ScrN Console Command: TOGGLEWEAPONLOCK - lock/unlocks your weapons on the ground."
    KFHints[28]="ScrN Console Commands: ToggleHudStyle, CoolHudSize, CoolHudAmmoSize, CoolHudAmmoX/Y - customize the HUD as you like."
    KFHints[29]="ScrN Balance: Medic gets XP for shooting zeds with Medic Guns. But do not forget to heal your teammates!"
    KFHints[30]="ScrN Balance: Combat Medic is more 'combat' than 'medic'"
    KFHints[31]="Social Isolation: The Virus gets spread by a close contact. Keep distance!"
    KFHints[32]="Social Isolation: Infected players should keep a distance from other infected as well. Increased Virus concentration in the air leads to severe symptoms."
    KFHints[33]="Social Isolation: Epidemic safety rules prohibit picking up items of infected players, even if you are already infected."
    KFHints[34]="Social Isolation: The Trader keeps her shop clean. Players get charged for coughing in the shop area - to cover the disinfection costs."
    KFHints[35]="Social Isolation: Rumors say that Toilet Paper can protect you from the Virus. At least you will die with a clean butt."
    KFHints[36]="Social Isolation: 'I can feel it coming in the air tonight, oh Lord!' Yes, it is the Virus in the air. And it is gonna kill you!"
    KFHints[37]="Social Isolation: The shop is a high-risk area for spreading the Virus. Keep distance and wait in line for shopping."
