...
defaultproperties
{
    ...
    MapAliases(00)=(FileName="KF-Abandoned-Moonbase",AchName="KF-MoonBase")
    MapAliases(01)=(FileName="KF-BigSunriseBeta1-6",AchName="KF-BigSunrise")
    MapAliases(02)=(FileName="KF-Clandestine-SE",AchName="KF-Clandestine",OriginalMap="KF-Clandestine-SE")
    MapAliases(03)=(FileName="KF-Constriction-SE",AchName="KF-Constriction")
    MapAliases(04)=(FileName="KF-DepartedNight",AchName="KF-Departed")
    MapAliases(05)=(FileName="KF-Doom2-Final-V7",AchName="KF-D2M1")
    MapAliases(06)=(FileName="KF-Doom2-HiRes",AchName="KF-D2M1")
    MapAliases(07)=(FileName="KF-Doom2-HiRes11",AchName="KF-D2M1")
    MapAliases(08)=(FileName="KF-Doom2-SE",AchName="KF-D2M1")
    MapAliases(09)=(FileName="KF-FoundryLightsOut",AchName="KF-Foundry")
    ...
    MapAliases(20)=(FileName="KF-Steamland_Fogged",AchName="KF-Steamland")
    MapAliases(21)=(FileName="KF-Train-fix",AchName="KF-Train")
    MapAliases(22)=(FileName="KF-ZedDiscoThe1stFloor",AchName="KF-ZedDisco",OriginalMap="KF-ZedDiscoThe1stFloor")
    MapAliases(23)=(FileName="KF-ZedDiscoThe2ndFloor",AchName="KF-ZedDisco",OriginalMap="KF-ZedDiscoThe2ndFloor")
    MapAliases(24)=(FileName="KFT-ScrnTestGrounds",OriginalMap="KF-ScrnTestGrounds")
    MapAliases(25)=(FileName="KFT-ScrnTestGrounds-SE",OriginalMap="KF-ScrnTestGrounds-SE")
}
