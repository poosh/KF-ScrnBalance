...
{
    if ( Mut.ScrnGT != none ) {
        Mut.ScrnGT.SetBoringStage(min(Mut.MapInfo.BoringStage, Mut.ScrnGT.BoringStages.Length - 1));
    }
...
defaultproperties
{
    ...
    HardcoreZeds(0)=(MonsterClass="Ghost",HL=0.5)
    HardcoreZeds(1)=(MonsterClass="Shiver",HL=1.0)
    HardcoreZeds(2)=(MonsterClass="Jason",HL=1.5)
    HardcoreZeds(3)=(MonsterClass="TeslaHusk",HL=1.5)
    HardcoreZeds(4)=(MonsterClass="Brute",HL=2.0)
    HardcoreZeds(5)=(MonsterClass="FemaleFP",HL=2.5)
    HardcoreZeds(6)=(MonsterClass="FemaleFP_MKII",HL=2.5)
    HardcoreZeds(7)=(MonsterClass="GorefastG",HL=0.3)
    HardcoreZeds(8)=(MonsterClass="BloatG",HL=0.3)
    HardcoreZeds(9)=(MonsterClass="SirenG",HL=0.5)
    ...
    HardcoreBosses(1)=(MonsterClass="HardPatC",HL=2)
    HardcoreBosses(2)=(MonsterClass="HardPatG",HL=2)
    HardcoreBosses(3)=(MonsterClass="HardPatH",HL=2)
    HardcoreBosses(4)=(MonsterClass="HardPatX",HL=2)
    HardcoreBosses(5)=(MonsterClass="ZombieSuperBoss",HL=2)
    HardcoreBosses(6)=(MonsterClass="Sabaoth",HL=2)
    HardcoreBosses(7)=(MonsterClass="Vagary",HL=2)
    HardcoreBosses(8)=(MonsterClass="Maledict",HL=2)
    HardcoreBosses(9)=(MonsterClass="HunterInvul",HL=2)
